...
def learning_df_prep(grouped_frame_df, start_dec=1980, end_dec=1990, min_frame_total_count=2000,
                     min_established_noun_total_count=200, min_novel_noun_final_total_count=200,
                     max_novel_noun_current_count=100, n_s=8, n_q_train=8, n_q_eval=2):
...
def get_test_dfs(start_decade=1980, end_decade=1990):
